            ...
            <div className="row px-xl-5 pb-3">
                ...
                <div className="col-lg-4 col-md-6 pb-1">
                    <div
                        ...
                        style={{ padding: 30 }}
                    >
                        <p className="text-right">1 Products</p>
                        <a href="" className="cat-img position-relative overflow-hidden mb-3">
                ...
                <div className="col-lg-4 col-md-6 pb-1">
                    ...
                    >
                        ...
                        <h5 className="font-weight-semi-bold m-0">Cloth for baby's first steps</h5>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 pb-1">
                    <div
                    ...
                    >
                        ...
                        <h5 className="font-weight-semi-bold m-0">Milestone Blanket</h5>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 pb-1">
                    <div
